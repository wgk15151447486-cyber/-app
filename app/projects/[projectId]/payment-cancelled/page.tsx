...
export default async function PaymentCancelledPage({ params }: Props) {
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-16 sm:px-6 sm:py-24 text-center">
      ...
      <h1 className="mt-4 text-2xl font-bold tracking-tight">Payment Cancelled</h1>
      <p className="mt-2 text-muted-foreground">
        Your payment was not completed. You can try again whenever you&rsquo;re
        ready.
      </p>
